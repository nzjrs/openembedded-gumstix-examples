...
PREBUILT_VERSION=201008032044
PREBUILT_TYPE=console

################################################################################
# DO NOT EDIT BELOW HERE
################################################################################
BASE_URL="http://www.sakoman.com/feeds/omap3/glibc/images/overo/${PREBUILT_VERSION}"

MLO="MLO-overo-${PREBUILT_VERSION}"
ROOTFS="omap3-${PREBUILT_TYPE}-image-overo-${PREBUILT_VERSION}.tar.bz2"
UBOOT="u-boot-overo-${PREBUILT_VERSION}.bin"
KERNEL="uImage-overo-${PREBUILT_VERSION}.bin"
